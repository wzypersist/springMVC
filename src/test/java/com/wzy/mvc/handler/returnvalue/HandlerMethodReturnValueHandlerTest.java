...
import com.wzy.mvc.controller.TestReturnValueController;
...
public class HandlerMethodReturnValueHandlerTest {
    ...
    public void test() throws Exception {
        ...
        ResponseBodyMethodReturnValueHandler responseBodyMethodReturnValueHandler = new ResponseBodyMethodReturnValueHandler();
        ...
        composite.handleReturnValue(controller.testResponseBody1(), resBodyMethodParameter, mvContainer, null, response);
